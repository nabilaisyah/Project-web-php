...
<body>
    ...
    <div class="content-box">
        ...
        <p>
           <?php
                for ($i=1;$i<=10;$i++) //Perulangan dilakukan dari 1 sampai 10
                { 
                if ($i == 7) continue; //perintah continue membuat perulangan melewatkan proses cetak angka 7
                echo " $i"; //1 2 3 4 5 6 8 9 10 (angka 7 tidak ditampilkan)
                } 
            ?>
        </p>
       <hr>
